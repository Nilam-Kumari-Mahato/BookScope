...
export default function NavBar(){
    return (
        <div className=' fixed bottom-0 flex  w-full justify-center bg-white flex-row md:fixed md:top-0 md:left-0  md:flex md:flex-col md:h-186  md:w-16 md:justify-center gap-10 items-center md:p-2 md:border-gray-200 md:border-r shadow-r'>
