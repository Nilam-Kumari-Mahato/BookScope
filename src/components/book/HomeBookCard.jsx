...
export default function HomeBookCard( {book} ) {
    ...
    return(
        <div 
            onClick={handleclick}
            key={book.id} 
            className="flex flex-col gap-4 justify-arround m-2 p-4 bg-amber-800/20 rounded-lg cursor-pointer transtion-all ease-in-out duration-200 hover:shadow-amber-950"
        >
            <div>
